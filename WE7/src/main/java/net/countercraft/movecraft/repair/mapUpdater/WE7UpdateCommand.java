package net.countercraft.movecraft.repair.mapUpdater;
...
public class WE7UpdateCommand extends UpdateCommand {
    private final BaseBlock baseBlock;
    private World world;
    private MovecraftLocation location;
    private Material type;
    public WE7UpdateCommand(BaseBlock baseBlock, World world, MovecraftLocation location, Material type){
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof WE7UpdateCommand)){
            return false;
        }
        WE7UpdateCommand weUp = (WE7UpdateCommand) obj;
